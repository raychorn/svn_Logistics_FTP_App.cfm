...
<head>
	<cfoutput>
		<title>#Request.title_bar# (FTP 2 Datamart) [#Request.system_run_mode#] [#Request.iml_soap_server_url#] [#nocache#]</title>
		#Request.meta_vars#
	</cfoutput>
...
<body>
	...
	<table width="100%" align="center" cellpadding="-1" cellspacing="-1">
		<tr>
			<td width="10%" align="left">
				<input type="button" id="btn_close_it" value="[Close Window]" class="buttonClass" onClick="parent.DHTMLWindowsObj.closeit(parent.aDHTMLObj104.id);">
			</td>
	...
	<cfoutput>
		<cfset _url = 'ftp-datamart-content.cfm?nocache=' & URLEncodedFormat(CreateUUID()) & '&recid=' & recid & '&repName=' & URLEncodedFormat(repName) & '&dm_id=' & dm_id & '&allow_dl=' & allow_dl & '&repType=' & URLEncodedFormat(repType) & '&filePath=' & URLEncodedFormat(filePath)>
