<cfscript>
	if (IsDefined("URL.title_bar")) {
		Request.title_bar = URL.title_bar & ' (Forgot Password)';
		Request._title_bar = Request.title_bar;
	} else if (IsDefined("FORM.title_bar")) {
		Request.title_bar = FORM.title_bar & ' (Forgot Password)';
		Request._title_bar = Request.title_bar;
	}
...
<cfsavecontent variable="html_ForgotPasswordForm">
	<cfoutput>
...
<cfscript>
	writeOutput(Request.html_headerContent & html_ForgotPasswordForm);
</cfscript>
